...
const Footer: React.FC = () => {
    ...
    return (
        ...
        <div className='w-full h-auto min-h-[128px] bg-gradient-to-t from-white from-30% to-transparent backdrop-blur-lg flex flex-col gap-y-8 p-8 lg:p-16 pt-16'>
            
            <div className='w-full h-4/5 flex flex-row gap-x-12 '>

                <div className='w-1/3 flex flex-col gap-y-2'>
                    <h1 className='text-xl lg:text-[30px] font-bold '>MUC</h1>
                    <p className='text-xs lg:text-[18px] lg:py-4 text-gray-800'>Transforming Lives With Music</p>
